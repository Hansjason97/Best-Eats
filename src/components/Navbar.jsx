  ...
  return (
    <div className='max-w-[1640px] mx-auto flex justify-between items-center p-4'>
        ...
        <div className='flex items-center'>
            ...
            <h1 className='text-2xl sm:text-3xl lg:text-4xl px-2'>Best <span className='font-bold text-orange-500'>Eats</span>
            </h1>
        ...
        { nav ? <div className='bg-black/80 fixed w-full h-screen z-10 top-0 left-0' onClick={()=> setNav(!nav)}></div> : ''}
         ...
         {/*Side drawer menu*/}
         <div className={ nav ? 'fixed top-0 left-0 w-[300px] h-screen bg-white z-10 duration-300 ease-in-out' : 'fixed top-0 left-[-100%] w-[300px] h-screen bg-white z-10 duration-1000 ease-in'}>
            <AiOutlineClose 
            onClick={()=> setNav(!nav)}
            size={30} className='absolute right-4 top-4 cursor-pointer' />
            <h2 className='text-2xl p-4'>
                Best <span className='font-bold text-orange-500'>Eats</span></h2>
                <nav>
